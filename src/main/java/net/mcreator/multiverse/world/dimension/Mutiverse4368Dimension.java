...
package net.mcreator.multiverse.world.dimension;
...
import net.mcreator.multiverse.item.Mutiverse4368Item;
import net.mcreator.multiverse.block.Multivere4368portalblockBlock;
...
public class Mutiverse4368Dimension extends MultiverseModElements.ModElement {
	@ObjectHolder("multiverse:mutiverse_4368_portal")
	public static final CustomPortalBlock portal = null;

	public Mutiverse4368Dimension(MultiverseModElements instance) {
		super(instance, 2);
	...
	public void init(FMLCommonSetupEvent event) {
		...
		replaceableBlocks.add(Blocks.MAGMA_BLOCK);
		...
		replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("multiverse:universe_43682")).getGenerationSettings()
				.getSurfaceBuilder().get().getConfig().getTop().getBlock());
		replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("multiverse:universe_43682")).getGenerationSettings()
				.getSurfaceBuilder().get().getConfig().getUnder().getBlock());
		replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("multiverse:universe_4368")).getGenerationSettings()
				.getSurfaceBuilder().get().getConfig().getTop().getBlock());
		replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("multiverse:universe_4368")).getGenerationSettings()
				.getSurfaceBuilder().get().getConfig().getUnder().getBlock());
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("multiverse:mutiverse_4368"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("mutiverse_4368_portal", Vector3i::compareTo, 300);
	...
	public static class POIRegisterHandler {
		...
		public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
			poi = new PointOfInterestType("mutiverse_4368_portal", Sets.newHashSet(ImmutableSet.copyOf(portal.getStateContainer().getValidStates())),
					0, 1).setRegistryName("mutiverse_4368_portal");
	...
	public void initElements() {
		...
		elements.items.add(() -> new Mutiverse4368Item().setRegistryName("mutiverse_4368"));
	}
	...
	public static class CustomPortalBlock extends NetherPortalBlock {
		public CustomPortalBlock() {
			...
			setRegistryName("mutiverse_4368_portal");
		}
			...
			if (!entity.isPassenger() && !entity.isBeingRidden() && entity.isNonBoss() && !entity.world.isRemote && true) {
				if (entity.func_242280_ah()) {
					entity.func_242279_ag();
						...
						new ResourceLocation("multiverse:mutiverse_4368"))) {
					entity.func_242279_ag();
					teleportToDimension(entity, pos,
							RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("multiverse:mutiverse_4368")));
				} else {
					entity.func_242279_ag();
	...
	public static class CustomPortalSize {
		private static final AbstractBlock.IPositionPredicate POSITION_PREDICATE = (state, blockReader, pos) -> {
			return state.getBlock() == Multivere4368portalblockBlock.block;
		};
				...
				for (int l1 = -1; l1 < 2; ++l1) {
					for (int k2 = 0; k2 < 2; ++k2) {
						for (int i3 = -1; i3 < 3; ++i3) {
							BlockState blockstate1 = i3 < 0 ? Multivere4368portalblockBlock.block.getDefaultState() : Blocks.AIR.getDefaultState();
			...
			for (int k1 = -1; k1 < 3; ++k1) {
				for (int i2 = -1; i2 < 4; ++i2) {
					if (k1 == -1 || k1 == 2 || i2 == -1 || i2 == 3) {
						...
						this.world.setBlockState(blockpos$mutable, Multivere4368portalblockBlock.block.getDefaultState(), 3);
					}
				}
			}
