...
public class Universe4368Biome extends MultiverseModElements.ModElement {
	public static Biome biome;

	public Universe4368Biome(MultiverseModElements instance) {
		super(instance, 3);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-3368704).setWaterColor(-3381760).setWaterFogColor(-13434880)
						.withSkyColor(-3368704).withFoliageColor(-10066330).withGrassColor(-13421773)
						...
						.setParticle(new ParticleEffectAmbience(ParticleTypes.SMOKE, 0.118f)).build();
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION,
						Feature.DISK
								.withConfiguration(new SphereReplaceConfig(Blocks.SAND.getDefaultState(), FeatureSpread.func_242253_a(2, 4), 2,
										ImmutableList.of(Blocks.MAGMA_BLOCK.getDefaultState(), Blocks.OBSIDIAN.getDefaultState())))
				...
				event.getRegistry().register(biome.setRegistryName("multiverse:universe_4368"));
			}
		}
	}
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("universe_4368_lvtd");
		...
		protected void func_227424_a_(IWorldWriter ww, BlockPos bp, BooleanProperty bpr, Set<BlockPos> sbc, MutableBoundingBox mbb) {
			this.func_227423_a_(ww, bp, Blocks.CRIMSON_ROOTS.getDefaultState(), sbc, mbb);
		}
	}
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("universe_4368_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("universe_4368_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
