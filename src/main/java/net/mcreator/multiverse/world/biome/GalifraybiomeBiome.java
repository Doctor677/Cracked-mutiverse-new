...
public class GalifraybiomeBiome extends MultiverseModElements.ModElement {
	public static Biome biome;

	public GalifraybiomeBiome(MultiverseModElements instance) {
		super(instance, 17);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("multiverse:galifraybiome"));
			}
		}
	}
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("galifraybiome_ctd");
